<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-categoria">
                <div class="text-center">
                    <abbr title="GALINHA PINTADINHA"><img class="imagem img-fluid" src="img/GalinhaPintadinha.png" alt=""></abbr>
                </div>
            </div>
            <div class="col-categoria">
                <div class="text-center">
                    <abbr title="MUNDO BITA"><img class="imagem img-fluid" src="img/MundoBita.jpg" alt=""></abbr>
                </div>
            </div>
            <div class="col-categoria">
                <div class="text-center">
                    <abbr title="PALAVRA CANTADA"><img class="imagem img-fluid" src="img/PalavraCantada.jpg" alt=""></abbr>
                </div>
            </div>
            <div class="col-categoria">
                <div class="text-center">
                    <abbr title="PATATI PATATA"><img class="imagem img-fluid" src="img/PatatiPatata.jpg" alt=""></abbr>
                </div>
            </div>
            <div class="col-categoria">
                <div class="text-center">
                    <abbr title="XUXA"><img class="imagem img-fluid" src="img/xuxa.jpg" alt=""></abbr>
                </div>
            </div>
        </div>
    </div>
